...
const keywordIncludes = [
  // eSIM / SIM
  'esim', 'e-sim', 'е-сим', 'есим', 'сим', 'симка', 'симку', 'симки', 'симок',
  'sim card', 'sim-card', 'сим карт', 'сим-карт', 'sim',

  // связь / интернет
  'связь', 'связи', 'свзяь', 'связ', 'интернет', 'моб интернет', 'мобильный интернет', 'мобильная связь',
  'data', 'traffic', 'трафик', 'данные', 'покрытие', 'ловит сеть', 'не ловит сеть', 'ловит связь', 'не ловит связь',
  'плохо ловит', 'сеть не ловит', 'нет сети', 'нет интернета',
  'wifi', 'wi-fi', 'вайфай', 'роуминг', '4g', '5g', 'lte', '3g',

  // тарифы / цены
  'тариф', 'тарифы', 'пакет', 'пакеты', 'безлимит', 'гб', 'гигабайт', 'мб', 'мегабайт',
  'дешевый интернет', 'дешёвый интернет', 'дешевле интернет', 'цены на сим', 'цена esim',

  // intent
  'где купить сим', 'где взять сим', 'где оформить сим', 'где купить esim',
  'какую сим', 'какую симку', 'какой esim', 'как подключить esim', 'как подключить сим',
  'как активировать esim', 'как активировать сим', 'как настроить интернет',
  'посоветуйте сим', 'нужна сим', 'нужен интернет', 'купить симку', 'купить esim',

  // операторы RU/CIS
  'мтс', 'билайн', 'мегафон', 'теле2', 'теле 2', 'yota', 'йота', 'тинькофф мобайл',
  'tinkoff mobile', 'ростелеком', 'мотив',

  // операторы VN/SEA + глобальные eSIM бренды
  'viettel', 'vinaphone', 'mobifone', 'vietnamobile',
  'dtac', 'ais', 'true', 'truemove', 'smartfren', 'telkomsel', 'xl', 'indosat',
  'airalo', 'holafly', 'nomad', 'yesim', 'drimsim', 'ubigi', 'gigsky', 'saily',

  // гео-контекст
  'во вьетнаме', 'вьетнаме интернет', 'в таиланде', 'на бали', 'в индонезии',
  'в турции', 'в дубае', 'в оаэ', 'в малайзии', 'в сингапуре', 'в японии', 'в корее'
];
